package com.kaanf.oris.api.exception
...
import com.kaanf.oris.domain.exception.RateLimitException
...
class AuthExceptionHandler {
    ...
    fun onUserAlreadyExist(e: UserAlreadyExistsException) =
        mapOf("code" to "USER_EXISTS", "message" to e.message)
    ...
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    fun onInvalidCredentials(e: InvalidCredentialsException) =
        mapOf("code" to "INVALID_CREDENTIALS", "message" to e.message)

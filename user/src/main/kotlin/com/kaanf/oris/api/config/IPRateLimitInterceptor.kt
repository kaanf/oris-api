...
import com.kaanf.oris.infra.cache.IPRateLimiter
import com.kaanf.oris.infra.cache.IPResolver
...
class IPRateLimitInterceptor(
    ...
    @param:Value("\${oris.rate-limit.ip.apply-limit}") private val applyLimit: Boolean,
): HandlerInterceptor {
